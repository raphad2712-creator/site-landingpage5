# 5 anos da Perfeita Plástica

Landing page estática baseada no PDF fornecido, pronta para GitHub Pages. Abra `index.html` ou sirva a pasta com `python3 -m http.server`.
